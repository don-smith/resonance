export default function createHomePackage({ fetchFn = fetch } = {}) {
  ...
  return {
    mount(mountRoot) {
      root = mountRoot;
      root.innerHTML = '<article class="home-content"><p class="eyebrow">A LOCAL DEVELOPMENT COCKPIT</p><div class="home-body"><p class="home-loading">Loading Home…</p></div></article>';
